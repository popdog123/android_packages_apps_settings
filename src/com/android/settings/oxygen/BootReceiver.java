...
public class BootReceiver extends BroadcastReceiver {
    ...
    private void configureCPU(Context ctx) {
        ...
        String availableFrequenciesLine = Utils.fileReadOneLine(CPUSettings.FREQ_LIST_FILE);
        String availableGovernorsLine = Utils.fileReadOneLine(CPUSettings.GOV_LIST_FILE);
